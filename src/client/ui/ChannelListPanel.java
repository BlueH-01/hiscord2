...
public class ChannelListPanel extends JPanel {
    ...
    private PrintWriter out;                  // 서버와 통신하기 위한 출력 스트림
    private JPanel cardPanel;                 // MainFrame의 CardPanel
    private CardLayout cardLayout;            // MainFrame의 CardLayout
    private List<String> channels;
    private BufferedReader in;
    public ChannelListPanel(BufferedReader in, PrintWriter out, JPanel cardPanel, CardLayout cardLayout) {
        this.in =in;
        this.out = out;
    ...
    private void addChannels(){ //chatpanel,memberpanel,infopanel
        ...
        if (directories != null) {
            for (File dir : directories) {
                ...
                cardPanel.add(new ChannelPanel(dir.getName(),cardLayout,in,out),dir.getName());
